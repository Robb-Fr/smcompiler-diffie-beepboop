...
class Expression:
    ...
    # useful for being able to use it as keys of dictionnaries
    def __hash__(self):
        return hash(self.id)
...
class Op(Expression):
    """Term representing an operation expression, having two operands"""
    ...
    def get_operands(self) -> Tuple[Expression, Expression]:
        """Returns the tuple of operands held by this operation"""
